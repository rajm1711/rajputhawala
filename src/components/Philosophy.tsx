...
import { Zap, Layers, Lock, ShieldCheck, Activity } from "lucide-react";
...
export default function Philosophy() {
  ...
  return (
    <section id="philosophy" className="py-20 relative overflow-hidden transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-12 text-center max-w-2xl mx-auto">
          ...
          <h2 className="text-2xl sm:text-4xl font-semibold font-heading text-foreground tracking-tight leading-snug">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          ...
          <motion.div
            ...
            className="lg:col-span-5 glass-panel p-6 sm:p-7 rounded-2xl border border-border flex flex-col justify-between shadow-xl gradient-border"
          >
            <div>
              <div className="flex items-center justify-between pb-3 border-b border-border mb-4">
                <span className="text-[10px] font-mono uppercase font-semibold text-cyan-600 dark:text-cyan-400">
                  PHILOSOPHY // STATEMENT
                </span>
                <span className="px-2 py-0.5 rounded-full text-[9px] font-mono bg-purple-500/10 text-purple-600 dark:text-purple-400 border border-purple-500/30">
                  SYSTEMS MINDSET
                </span>
              </div>
              ...
              <p className="text-xs text-gray-600 dark:text-gray-300 leading-relaxed font-normal space-y-2 mb-4">
                As a Full Stack Engineer at Codelamda Technology and creator of EdgeIQ AI Platform, I deconstruct real-world workflows into clean system blueprints.
              </p>
              <p className="text-xs text-gray-600 dark:text-gray-300 leading-relaxed font-normal">
                Every component serves a purpose: from low-overhead state containers to cloud-deployed Docker containers on Render and edge routing on Vercel.
              </p>
            </div>
          ...
          <div className="lg:col-span-7 grid grid-cols-1 gap-4">
            {principles.map((item, idx) => (
              <motion.div
                ...
                whileHover={{ y: -3 }}
                className="glass-panel p-5 rounded-xl border border-border flex items-start gap-4 shadow-md hover:border-cyan-500/40 transition-all"
              >
                <div className="p-2.5 rounded-xl bg-black/5 dark:bg-white/5 border border-border shrink-0">
                  {item.icon}
                </div>
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className="text-[10px] font-mono font-medium text-cyan-600 dark:text-cyan-400 bg-cyan-500/10 px-2 py-0.5 rounded-md">
                      {item.tag}
                    </span>
                  </div>
